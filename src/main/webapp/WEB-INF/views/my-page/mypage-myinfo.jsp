                                            ...
                                            <div id="first-box">
                                                ...
                                                <div id="my-popularity">
                                                    <div id = "follow-info-box">
                                                        <div class="my-popularity-data"><span>팔로워</span><span class = "data">${me.followers}</span>건</div>
                                                        <div class="my-popularity-data"><span>팔로잉</span><span class = "data">${me.followings}</span>건</div>
                                                        <div class="my-popularity-data"><span>호감도</span><span class = "data">${me.userAvgRate}</span>P</div>
                                                    </div>
                                                    <div id = "other-info-box">
                                                        <div class="my-other-data"><span>팔로워 순위</span><span class = "data">${me.rank}</span>등</div>
                                                        <div class="my-other-data"><span>비매너 신고</span><span class = "data">${me.accuseCount}</span>건</div>
                                                        <div class="my-other-data"><span>총 활동점수</span><span class = "data">${me.totalScore}</span>점</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="second-box">
                                        ...
                                        <div id="my-board-activity">
                                            ...
                                            <div id="my-board-point-info">
                                                <div id="my-board-history"><p class = "activity-title">내 활동</p>
                                                    <div class="my-board-data"><p>작성 게시글 수</p><span class = "data-amount">0</span>건<span class = "point-amount">0</span>POINT</div>
                                                    <div class="my-board-data"><p>작성 댓글 수</p><span class = "data-amount">0</span>건<span class = "point-amount">0</span>POINT</div>
                                                </div>
                                                <div id="my-point-history"><p class = "activity-title">내 포인트</p>
                                                    <div class="my-point-data"><p>오늘 획득한 포인트</p><span class = "data-amount">0</span>POINT</div>
                                                    <div class="my-point-data"><p>이달 획득한 포인트</p><span class = "data-amount">0</span>POINT</div>
                                                    <div class="my-point-data"><p>누적 획득 포인트</p><span class = "data-amount">0</span>POINT</div>
                                                    <div class="my-point-data"><p>누적 사용 포인트</p><span class = "data-amount">0</span>POINT</div>
                                                    <div id = "current-point"><p>사용 가능 포인트</p><span class = "data-amount">0</span>POINT</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
