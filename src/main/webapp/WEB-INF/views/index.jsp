...
<%--<div id="main-wrapper">--%>
    ...
    <div id="search-bar">
        ...
        <div id="searchBy-gender">
            <input class = "select-gender" id = "gender-m" type = "radio" name = "gender" value = "M"><label for = "gender-m" class = "gender-option">남</label>
            <input class = "select-gender" id = "gender-f" type = "radio" name = "gender" value = "F"><label for = "gender-f" class = "gender-option">여</label>
        </div>
        <!--        티어 검색 라디오 -->
        <div id="searchByTier">
        ...
        <div class = "duo-profile">
            ...
            <div class = "profile-left-side">
                ...
                <div class = "profile-sns">
                    <a href="#" class = "sns-type instagram"><img class = "sns-image" src="/assets/img/main/instagram.png" alt="instagram"></a>
                    <a href="#" class = "sns-type facebook"><img class = "sns-image" src="/assets/img/main/facebook.png" alt="facebook"></a>
                    <a href="#" class = "sns-type twitter"><img class = "sns-image" src="/assets/img/main/twitter.png" alt="twitter"></a>
            ...
            <div class = "profile-right-side">
                ...
                <div class = "rate-matching-point">
                    <div class = "rate-matching-point rate-point-box"><img class = "rate-matching-point-image" src="/assets/img/main/star.png" alt="rate"><p class = "avg-rate">89.2</p></div>
                    <div class = "rate-matching-point matching-point-box"><img class = "rate-matching-point-image" src="/assets/img/main/coin.png" alt="coin"><p class = "matching-point">500</p></div>
                </div>
                <div class = "profile-comment"><p>여기에 자기소개를 적을거에요^^ 같이 게임해용~~~</p></div>
                <div class = "profile-most-champ">
                    <ul class = "champ-list">
                        <li class = "most-pic first-champ"><img src="/assets/img/main/Skarner_3.jpg" alt = "first-champ"></li>
                        <li class = "most-pic second-champ"><img src="/assets/img/main/TahmKench_0.jpg" alt = "second-champ"></li>
